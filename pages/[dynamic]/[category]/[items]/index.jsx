...
const Index = () => {
    ...
    useEffect(() => {
        ...
        if (categoryitemlist.length === 0) {
            ...
            const catagerySelected = maincategoryList.filter(x => x.catName.toLowerCase().toString().replace(/[^a-zA-Z0-9]/g, " ").replace(/\s{2,}/g, ' ').replace(/ /g, "-") === urlArray[2].toLowerCase().toString().replace(/[^a-zA-Z0-9]/g, " ").replace(/\s{2,}/g, ' ').replace(/ /g, "-"))
