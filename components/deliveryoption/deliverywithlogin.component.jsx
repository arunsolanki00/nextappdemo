...
import PickupDropdawnComponent from "../Header/pickup-dropdawn.component";
...
const Deliverywithlogin = () => {
    ...
    // const [restaurantColor, setRestaurantColor] = useState(restaurantinfo?.color ? restaurantinfo?.color: );
    // useEffect(() => {
    //     dispatch(setpickupordelivery('Delivery'));
    //     dispatch(getSelectedRestaurantTime(restaurantinfo.restaurantId, restaurantinfo.defaultLocation.locationId));
    // }, []);
                            ...
                            .then((response) => {
                                ...
                                if (response.result != undefined && response.result !== null) {
                                    if (response.result.status === "success") {
                                        ...
                                        // setTimeOrErrorMessage(DeliveryConfirmationMessage.DELIVERY_CLOSE_TODAY_DESC);
                                        setTimeOrErrorMessage(response.result?.message);
                                        setDisplayASAPTime(false);
                                        setisDisabled(true);
                                    }
    ...
    const handleaddressclick = (item) => {
        ...
        // if (item.deliveryaddressId == undefined && item?.deliveryaddressId > 0) {
    ...
    // useEffect(() => {
    //     if (selecteddelivery === null && deliverydata && deliverydata?.length > 0) {
    //         let paddress = null;
    //         let baddress = null;
    ...
    //         });
    //         if (paddress !== null)
    //             dispatch(selecteddeliveryaddress(paddress));
    //         else if (baddress !== null)
    //             dispatch(selecteddeliveryaddress(baddress));
    //     }
    // }, [deliverydata?.length]);
                                        ...
                                        <div className="col-lg-11 sp-d col-sm-11 col-xs-12">
                                            ...
                                            <div className="row in">
                                                <div className="col-lg-4 col-sm-4 col-xs-12">
                                                    {/* <div className="col-lg-12 col-sm-12 col-xs-12 full_grey_border bg_grey padding_10 border_radius_20 minHeightAddBox">
                                                    <h5 className="size_22 color_black weight_300 margin_bottom_20"><img src="/images/pin.png" alt="" /><span className="size_20 color_grey margin_top_0">949 Eglinton,<br />Eglinton Ave W,<br />New York, 92010</span></h5>
                                                </div> */}
                                                    {/* {tempDeliveryAddress &&
                                                        <div onClick={() => handleaddressclick(tempDeliveryAddress)} >
                                                            <div className={"col-lg-12 col-sm-12 col-xs-12 padding_10 margin_top_6 border_radius_20 bg_grey full_grey_border_selected"} >
                                                                <h5 className="size_22 color_black weight_300 margin_bottom_20">
                                                                    <img src="/images/pin.png" alt="" />
                                                                    <span className="size_20 margin_top_0 color_grey">
                                                                        <>{tempDeliveryAddress?.address1?.length > 0 && <>{tempDeliveryAddress.address1.replace(/,\s*$/, "")} </>}
                                                                            {tempDeliveryAddress?.city?.length > 0 && <><br /> {tempDeliveryAddress.city.replace(/,\s*$/, "")} </>}
                                                                            {tempDeliveryAddress?.state?.length > 0 && <> <br /> {tempDeliveryAddress.state.replace(/,\s*$/, "")}  </>}
                                                                            {tempDeliveryAddress?.zipcode?.length > 0 && <><br /> {tempDeliveryAddress.zipcode.replace(/,\s*$/, "")} </>}
                                                                        </>
                                                                    </span>
                                                                </h5>
                                                            </div>
                                                    ...
                                                    {deliverydata != undefined && deliverydata != null && deliverydata && deliverydata.length > 0 && deliverydata.filter(x => x.addresstype === 0).length > 0 &&
                                                        deliverydata.filter(x => x.addresstype === 0).map((item, index) => {
                                                            let classname = "col-lg-12 col-sm-12 col-xs-12 padding_10 margin_top_6 border_radius_20";//(selectedAddressId > 0 ? (item.deliveryaddressId === selectedAddressId) : (selecteddelivery && item.deliveryaddressId === selecteddelivery.deliveryaddressId) ? 'bg_grey full_grey_border_selected' : ' full_grey_border');
                                                ...
                                                <div className="col-lg-4 col-sm-4 col-xs-12">
                                                    {deliverydata != undefined && deliverydata != null && deliverydata && deliverydata.length > 0 && deliverydata.filter(x => x.addresstype === 1).length > 0 &&
                                                        deliverydata.filter(x => x.addresstype === 1).map((item, index) => {
                                                            ...
                                                            let classname = "col-lg-12 col-sm-12 col-xs-12 padding_10 margin_top_6 border_radius_20 ";//(selectedAddressId > 0 ? (item.deliveryaddressId === selectedAddressId) : (selecteddelivery && item.deliveryaddressId === selecteddelivery.deliveryaddressId) ? 'bg_grey full_grey_border_selected' : 'full_grey_border');
                                                            // if (selectedAddressId > 0 && (item.deliveryaddressId === selectedAddressId)) {
                                                            if (addressId === item.deliveryaddressId) {
                                                                handleaddressclick(item);
                                                                classname += " bg_grey full_grey_border_selected";
                                                            }
                                                            ...
                                                            return (
                                                                <div onClick={() => handleaddressclick(item)} style={index === 0 || index === 1 ? { display: "block", cursor: "pointer" } : (index !== 0 && index !== 1 && ismore === true ? { display: "block", cursor: "pointer" } : { display: "none", cursor: "pointer" })} key={index}>
                                                                    {/* <div className={"col-lg-12 col-sm-12 col-xs-12 padding_10 margin_top_15 border_radius_20 minHeightAddBox " + (selecteddelivery && item.deliveryaddressId === selecteddelivery.deliveryaddressId ? 'bg_grey full_grey_border_selected' : 'full_grey_border')}> */}
                                                                    {/* <div className={"col-lg-12 col-sm-12 col-xs-12 padding_10 margin_top_6 border_radius_20 " + (selectedAddressId > 0 ? (item.deliveryaddressId === selectedAddressId) : (selecteddelivery && item.deliveryaddressId === selecteddelivery.deliveryaddressId) ? 'bg_grey full_grey_border_selected' : 'full_grey_border')}> */}
                                                                    <div className={classname} >
                                                                        <h5 className="size_22 color_black weight_300 margin_bottom_20">
                                                                            <img src="/images/pin.png" alt="" />
                                                                            <span className="size_20 margin_top_0 color_grey">
                                            ...
                                            <div className="row in margin_top_30">
                                                {/* <div className="col-lg-4 col-sm-4 col-xs-12">
                                                    <h5 className="size_22 color_black weight_300 margin_bottom_20"><i className="fa fa-clock-o"></i>
                                                        Pickup Window<br /><a data-toggle="modal" data-target="#myModal-2">
                                                            <span className="size_20 color_grey">
                                                                {pickuptime && pickuptime.length > 0 ? pickuptime : 'Closed Today!'}
                                                            </span>
                                                        </a></h5>                                            </div>
    
                                                <div className="col-lg-4 col-sm-4 col-xs-12">
                                                    <h5 className="size_22 color_black weight_300 margin_bottom_20"><i className="fa fa-clock-o"></i>Delivery Window<br />
                                                        <span className="size_20 color_grey">
                                                            {deliverytime && deliverytime.length > 0 ? deliverytime : 'Closed Today!'}
                                                        </span></h5>
                                                </div> */}
                                                        ...
                                                        <div className="col-lg-10 column-centered flush col-sm-10 col-xs-12">
                                                            ...
                                                            {deliveryWindow && deliveryWindow.length > 0 ?
                                                                <>
                                                                    ...
                                                                    <div className="col-lg-12 dd text-center col-sm-12 col-xs-12">
                                                                        {displayASAPTime && orderTime &&
                                                                            // <h5 className="color_black">Today at {orderTime} </h5>
                                                                ...
                                                                <>
                                                                    ...
                                                                    {/* <div className="col-lg-12 dd text-center col-sm-12 col-xs-12">
                                                                        <h3 className="removembottom color_red" style={redColorStyle}> {DeliveryConfirmationMessage.CLOSE_TODAY} </h3>
                                                                    </div> */}
                                                                    <div className="col-lg-12 dd text-center col-sm-12 col-xs-12">
                                                                    ...
                                                                    {orderTime ?
                                                                        <>
                                                                            <Link href="/[dynamic]/main" as={`/${restaurantinfo.restaurantURL}/main`}>
                                                                                <a className={orderTime ? "blue_btn blue_btn_porder" : "blue_btn blue_btn_porder disabled"}>Next</a>
                                                                            </Link></> :
                                                                        (
                                                                            <>
                                                                                <a title="Please select Estimated Delivery time" href="javascript:void(0)" className="blue_btn blue_btn_porder disabled">Next</a>
                                                                            </>
                                                                            )
                                                                    }
                                                                </div> : ('')}
                                                            <div className="col-lg-4 text-center col-sm-4 col-xs-12">
                                                                <Link href="/[dynamic]/main" as={`/${restaurantinfo.restaurantURL}/main`}>
                                                                    <a className="blue_btn skipbtn active">Skip 1</a>
                                                                </Link>
                                                            </div>
                                                        </div> */}
                                                                    ...
                                                                    {!defaultLocation.isOrderingDisable ?
                                                                        <>
                                                                            {orderTime && orderTime !== "" ?
                                                                                ...
                                                                                :
                                                                                (<div className="col-lg-4 text-center col-sm-4 col-xs-12">
                                                                                    {/* <a className="blue_btn skipbtn" href="javascript:void(0)">Next</a> */}
