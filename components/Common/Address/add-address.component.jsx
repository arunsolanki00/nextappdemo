...
const AddAddress = (props) => {
    ...
    const sendDataToParent = (index) => {
        ...
        if (href.includes('myaccount')) {
            if (!props.reloadAddressList) {
    ...
    if (loadaddress === true)
        return (
            <>
                {<div id="myModaladdress" className="modal address fade" role="dialog">
                                ...
                                <div className="col-lg-12 text-center col-sm-12 col-xs-12">
                                    ...
                                    <div className="tab-content">
                                        <div id="tab-1" className="tab-pane fade in active">
                                            {<PersonalAddress ispersonal={active} sendDataToParent={sendDataToParent} />}
                                        </div>
                                    </div>
                                </div>
                            </div>
